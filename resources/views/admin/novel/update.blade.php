            ...
            <div class="tpl-block">
                ...
                <div class="am-g">
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" action="{{url('admin/novel/update')}}" enctype="multipart/form-data" method="post">
                            <div class="am-form-group">
                                {{csrf_field()}}
                                <label for="name" class="am-u-sm-3 am-form-label">小说名字 <span class="tpl-form-line-small-title">Title</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="name" name="name" value="{{$data['name']}}">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea class="" rows="10" id="desc" name="desc" placeholder="小说简介">{{$data['desc']}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input type="text" class="tpl-form-input" id="author" name="author" value="{{$data['author']}}" placeholder="请输入小说作者">
                                </div>
                            </div>
                            <div class="am-form-group">

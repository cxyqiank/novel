                    ...
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            @if(session('msg'))
                                {{session('msg')}}
                            @endif
                            <form class="am-form tpl-form-line-form" action="{{url('admin/notice/add')}}" enctype="multipart/form-data" method="post">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <textarea class="" rows="10" id="content" name="content" placeholder="章节内容"></textarea>
                                    </div>
                                </div>
                                <div class="am-form-group">

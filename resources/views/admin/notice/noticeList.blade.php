                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    ...
                                    @foreach($data as $v)
                                        <tr>
                                            ...
                                            <td>{{$v->id}}</td>
                                            <td>{{session('admin.admin')}}</td>
                                            <td>{{$v->content}}</td>
                                            <td>{{$v->created_at}}</td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> <a href="{{url('admin/notice/edit?id='.$v->id)}}">编辑</a></button>
                                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> <a href="{{url('admin/notice/delete?id='.$v->id)}}">删除</a></button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>

            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span>角色修改
                    </div>
                        ...
                        <div class="tpl-form-body tpl-form-line">
                            ...
                            <form class="am-form tpl-form-line-form" action="" enctype="multipart/form-data" method="post">
                                <div class="am-form-group">
                                    {{--csrf攻击--}}
                                    {{csrf_field()}}
                                    <label for="ame" class="am-u-sm-3 am-form-label">角色名</label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input  id="description" type="text" value="{{$data['description']}}" name="description">
                                    </div>
                                </div>
                                <div class="am-form-group">
